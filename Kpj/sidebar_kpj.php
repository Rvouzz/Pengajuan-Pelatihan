...
if (!isset($_SESSION['nik']) || !isset($_SESSION['level']) || $_SESSION['level'] !== 'kpj') {
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									...
									<span class="user-level"><?= htmlspecialchars(string: $level) ?></span>
					...
					<ul class="nav nav-primary" id="sidebarMenu">
						<li class="nav-item <?= in_array($current_file, ['dashboard_kpj.php']) ? 'active' : ''; ?>">
							<a href="dashboard_kpj.php">
						...
						<li
							class="nav-item <?= in_array($current_file, ['data_persetujuan_kpj.php', 'persetujuan_kpj.php']) ? 'active' : ''; ?>">
							<a href="data_persetujuan_kpj.php">
