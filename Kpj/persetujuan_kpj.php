...
$isDisabled = in_array($data_approval['approval_kpj'], [1, 2]) ? 'disabled' : '';
?>
...
<body>
                ...
                <div class="page-inner py-5">
                    <div class="page-header text-white">
                        ...
                        <ul class="breadcrumbs">
                            <li class="nav-home"><a href="dashboard_kpj.php"><i
                                        class="flaticon-home text-white"></i></a></li>
                            <li class="separator"><i class="flaticon-right-arrow"></i></li>
                            <li class="nav-item"><a href="data_persetujuan_kpj.php" class="text-white">Persetujuan
                                    Pengajuan</a></li>
                            <li class="separator"><i class="flaticon-right-arrow"></i></li>
                            <li class="nav-item"><a href="data_persetujuan_kpj.php" class="text-white">Data
                                    Persetujuan</a></li>
                            <li class="separator"><i class="flaticon-right-arrow"></i></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <select id="approval_kpj" class="form-control">
                                    <option value="0" <?php echo ($data_approval['approval_kpj'] == 0) ? 'selected' : ''; ?>>Menunggu</option>
                                    <option value="1" <?php echo ($data_approval['approval_kpj'] == 1) ? 'selected' : ''; ?>>Disetujui</option>
                                    <option value="2" <?php echo ($data_approval['approval_kpj'] == 2) ? 'selected' : ''; ?>>Ditolak</option>
                                </select>
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <textarea class="form-control" rows="4" placeholder="Tambahkan komentar..."
                                    name="komentar_kpj" <?php echo $isDisabled; ?>><?php echo htmlspecialchars($data_approval['komentar_kpj']); ?></textarea>
                                <br>
                                <?php if ($data_approval['approval_kepegawaian'] == 1): ?>
                                    <?php if (!in_array($data_approval['approval_kpj'], [1])): ?>
                                ...
                                <?php else: ?>
                                    <div class="alert alert-warning mt-3 text-center" role="alert">
                                        <strong>Perhatian:</strong> Kepegawaian belum selesai melakukan pengecekan kelengkapan berkas.
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
    ...
    <script>
        function kirim() {
            ...
            const komentar_kpj = $('textarea[name="komentar_kpj"]').val();
            const approval_kpj = $('#approval_kpj').val();

            $.ajax({
                url: './proses/simpan_approval.php',
                method: 'POST',
                data: {
                    komentar_kpj: komentar_kpj,
                    approval_kpj: approval_kpj,
                ...
                success: function (res) {
                    Swal.fire({
                        ...
                        window.location.href = 'data_persetujuan_kpj.php';
                    });
                },
