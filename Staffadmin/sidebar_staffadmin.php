...
if (!isset($_SESSION['nik']) || !isset($_SESSION['level']) || $_SESSION['level'] !== 'staff') {
					...
					<div class="collapse" id="search-nav">
						<ul class="navbar-nav navbar-left topbar-nav nav-search mr-md-3 align-items-center">
							...
							<li class="nav-item dropdown hidden-caret">
								<a aria-label="Current Date and Calender" class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
									<span id="date"></span>
								</a>
								...
								<li>
									<div class="user-box">
										...
										<div class="u-text">
											...
											<p class="text-muted"><?= htmlspecialchars($email) ?></p><a href="profile.html" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
										</div>
									</div>
								</li>
								<li>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary" id="sidebarMenu">
						<li class="nav-item <?= in_array($current_file, ['dashboard.php']) ? 'active' : ''; ?>">
						...
						<li class="nav-item <?= in_array($current_file, ['riwayat-pengajuan.php', 'detail_pengajuan.php', 'edit_pengajuan.php', 'edit_pengajuan']) ? 'active' : ''; ?>">
						...
						<li class="nav-item <?= in_array($current_file, ['upload.php']) ? 'active' : ''; ?>">
							<a href="upload.php">
								...
								<p>Berkas-berkas Pelatihan</p>
							</a>
						</li> -->
						<li class="nav-section">
							<h4 class="text-section">Kelengkapan Pengajuan</h4>
						</li>
						<li class="nav-item <?= in_array($current_file, ['data_verifikasi.php', 'verifikasi.php']) ? 'active' : ''; ?>">
							<a href="data_verifikasi.php">
								<i class="fas fa-clipboard-check"></i>
								<p>Verifikasi Berkas</p>
							</a>
						</li>
						<li class="nav-item <?= in_array($current_file, ['surat_tugas.php']) ? 'active' : ''; ?>">
							<a href="surat_tugas.php">
								<i class="far fa-envelope"></i>
								<p>Penerbitan Surat Tugas</p>
							</a>
						</li>
						<!-- <li class="nav-section">
							<h4 class="text-section">Laporan</h4>
						</li>
						<li class="nav-item <?= in_array($current_file, ['data_persetujuan.php', 'persetujuan.php']) ? 'active' : ''; ?>">
							<a href="data_persetujuan.php">
